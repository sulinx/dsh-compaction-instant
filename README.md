...
| Shared cores | `dsh-compaction-instant/recall` + `/search` + `/format` | Seq parsing (`12`, `3-7`, `seq 12` / `seqs 3-7`), log expansion, budgets, projection; ReDoS-guarded pattern compilation, BM25-lite ranking, snippet and path rendering |
